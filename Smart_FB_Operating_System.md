...
| AI-4 | **Chatbot NLP tiếng Việt** |cho nhân viên hỏi nguyên liệu , cách vận hành quán , Cho admin AL-1  | RAG (LLM + Vector DB) + PhoBERT intent | Tin nhắn khách: "trình bày cho Admin và staff" |Staff món này cần nguyên liệu này,.. Admin  Thống kê tháng này so với tháng trước hao hụt bao nhiêu,.. |
